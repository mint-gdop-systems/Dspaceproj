...
export const MetadataForm = ({ onNext, handleFinalUpload, collections, collectionId, setCollectionId, title, setTitle, description, setDescription, fileNumber, setFileNumber, fileNumberStatus, activeEntityType, plaintiffs, setPlaintiffs, defendants, setDefendants, caseRepresentatives, setCaseRepresentatives, manualEthioDate, setManualEthioDate, extraFields, updateExtraField, handleManualEthioDateChange, handlePickerDateChange, isSectionDisabled, files, setFiles, selectedFileId, setSelectedFileId, getFileIcon, formatFileSize, primaryFileId, setPrimaryFileId }) => {
  return (
          ...
          <div className="w-full max-w-[1000px] bg-white shadow-md border border-gray-200 border-t-4 border-t-[#265A91]">
              ...
              >
                <div className="space-y-8">
                  ...
                  {/* Dynamic sections based on activeEntityType can go here... */}
                  {/* Keep only the vital dynamic elements that were inside the old form if needed, or I can just drop them since I moved them into the "መረጃዎች" section above, but let's keep the extra dynamic logic if it exists */}
